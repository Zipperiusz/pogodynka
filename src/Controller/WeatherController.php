...
class WeatherController extends AbstractController
{
    ...
    public function city(string $city, ?string $country, WeatherRepository $weatherRepository, WeatherUtil $util): Response
    {

        $location = $weatherRepository->findLocationByCityAndCountry($city, $country);
